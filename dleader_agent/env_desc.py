...
data_lake_dict = {
    ...
    'ZINC': "250k_rndm_zinc_drugs_clean.smi ontains 250,000 randomly selected, standardized drug-like molecules from the ZINC database in SMILES format"
}
...
library_content_dict = {
    ...
    "xtb": "A Python package for simulation",
    # === R PACKAGES ===
