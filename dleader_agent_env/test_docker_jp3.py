import os
work_dir = "/home/ubuntu/work/dleader_agent_jp3/chat_sessions/session_20250912_203903_d25dd2f6"
pdb_file_path = "1QO9.pdb"
local_pdb_path = os.path.join(work_dir, "1EA5.pdb")
