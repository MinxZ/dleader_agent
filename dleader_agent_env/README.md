# dleader_agent Environment Setup
...
3. Lastly, to activate the dleader_agent environment:
```bash
...
The dleader_agent environment comes with a minimal set of langchain packages by default:
