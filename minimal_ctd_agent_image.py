...
# """)
    ...
    for file_path in ['/home/ubuntu/work/dleader_agent/pdf/400256000_22800AMX00681_F100_1.pdf']:
...
separate substrate and transporters into 2 csv. 
if you can not direct extract text using pypdf2, you can use image tools to let the llm to read the pdf as image and then extract the text, only do it when page is less than 10, otherwise directly say we can not read the file.
""")
